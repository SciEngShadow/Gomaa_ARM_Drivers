...
typedef enum{
    GPIO_PIN0 = 0U,  GPIO_PIN1 = 1U,  GPIO_PIN2 = 2U,
    GPIO_PIN3 = 3U,  GPIO_PIN4 = 4U,  GPIO_PIN5 = 5U,
    GPIO_PIN6 = 6U,  GPIO_PIN7 = 7U,
    GPIO_PINFULL = 7U
}Dt_GPIOPinNum_E;

typedef enum{
    GPIO_PIN_ADD_FULL = 0x3FCU
}Dt_GPIOPinAddCfg_E;
...
typedef enum{
    ...
    GPIO_PIN2_ADD_OFFSET    = 2U    ,
    GPIO_PIN3_ADD_OFFSET    = 3U    ,
    GPIO_PIN4_ADD_OFFSET    = 4U    ,
    GPIO_PIN5_ADD_OFFSET    = 5U    ,
...
#define GPIO_PORTx_DATA_BASE_ADDRESS_OFFSET                0x00000004U
...
#define MGPIO_DATA_REG_ONE_BYTE(BUS_NUM,PORT_NUM,PIN_ADD_OFFSET)  ( ( volatile Dt_MGPIO_PORTx_Data_REG_U*     )   ( GPIO_PORTx_BUSx_BASE_ADDRESS + PIN_ADD_OFFSET + (PORT_NUM * GPIO_PORTx_BUSx_PORT_DIFFERENCE) + (BUS_NUM * GPIO_PORTx_BUSx_BUS_DIFFERENCE) ) )
//#define MGPIO_DATA_REG(BUS_NUM,PORT_NUM,PIN_ADD_OFFSET)  ( ( volatile Dt_MGPIO_PORTx_Data_REG_U*     ) ( GPIO_PORTx_BUSx_BASE_ADDRESS + GPIO_PORTx_DATA_BASE_ADDRESS_OFFSET  + PIN_ADD_OFFSET + (PORT_NUM * GPIO_PORTx_BUSx_PORT_DIFFERENCE) + (BUS_NUM * GPIO_PORTx_BUSx_BUS_DIFFERENCE) ) )
