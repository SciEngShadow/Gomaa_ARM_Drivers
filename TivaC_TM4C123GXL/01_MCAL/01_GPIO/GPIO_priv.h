...
/*
#define GPIO_PORTx_AHB_BASE_ADDRESS     0x40058000U
#define GPIO_PORTx_APB_BASE_ADDRESS     0x40005000U
*/

/*
#define GPIO_PORTA_AHB_BASE_ADDRESS     0x40058000U
#define GPIO_PORTB_AHB_BASE_ADDRESS     0x40059000U
#define GPIO_PORTC_AHB_BASE_ADDRESS     0x4005A000U
#define GPIO_PORTD_AHB_BASE_ADDRESS     0x4005B000U
#define GPIO_PORTE_AHB_BASE_ADDRESS     0x4005C000U
#define GPIO_PORTF_AHB_BASE_ADDRESS     0x4005D000U

#define GPIO_PORTA_APB_BASE_ADDRESS     0x40005000U
#define GPIO_PORTB_APB_BASE_ADDRESS     0x40006000U
#define GPIO_PORTC_APB_BASE_ADDRESS     0x40007000U
#define GPIO_PORTD_APB_BASE_ADDRESS     0x40008000U
#define GPIO_PORTE_APB_BASE_ADDRESS     0x40024000U
#define GPIO_PORTF_APB_BASE_ADDRESS     0x40025000U
...
/*
#define MGPIO_AHB_CTRL1_REG(PORT_NUM) ( ( volatile Dt_MGPIO_PORTx_CTRL1_MemMap_S* )  ( GPIO_PORTx_AHB_BASE_ADDRESS + GPIO_PORTx_CTRL1_BASE_ADDRESS_OFFSET + (PORT_NUM * 0x1000U) ) )
#define MGPIO_AHB_CTRL2_REG(PORT_NUM) ( ( volatile Dt_MGPIO_PORTx_CTRL2_MemMap_S* )  ( GPIO_PORTx_AHB_BASE_ADDRESS + GPIO_PORTx_CTRL2_BASE_ADDRESS_OFFSET + (PORT_NUM * 0x1000U) ) )
#define MGPIO_AHB_CTRL3_REG(PORT_NUM) ( ( volatile Dt_MGPIO_PORTx_CTRL3_MemMap_S* )  ( GPIO_PORTx_AHB_BASE_ADDRESS + GPIO_PORTx_IDENTIFICATION_BASE_ADDRESS_OFFSET + (PORT_NUM * 0x1000U) ) )
#define MGPIO_APB_CTRL1_REG(PORT_NUM) ( ( volatile Dt_MGPIO_PORTx_CTRL1_MemMap_S* )  ( GPIO_PORTx_APB_BASE_ADDRESS + GPIO_PORTx_CTRL1_BASE_ADDRESS_OFFSET + (PORT_NUM * 0x1000U) ) )
#define MGPIO_APB_CTRL2_REG(PORT_NUM) ( ( volatile Dt_MGPIO_PORTx_CTRL2_MemMap_S* )  ( GPIO_PORTx_APB_BASE_ADDRESS + GPIO_PORTx_CTRL2_BASE_ADDRESS_OFFSET + (PORT_NUM * 0x1000U) ) )
#define MGPIO_APB_CTRL3_REG(PORT_NUM) ( ( volatile Dt_MGPIO_PORTx_CTRL3_MemMap_S* )  ( GPIO_PORTx_APB_BASE_ADDRESS + GPIO_PORTx_IDENTIFICATION_BASE_ADDRESS_OFFSET + (PORT_NUM * 0x1000U) ) )
*/
